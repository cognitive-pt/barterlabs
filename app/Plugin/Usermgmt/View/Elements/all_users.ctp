					...
					echo "<div class='btn-group'>";
						...
						echo "<ul class='dropdown-menu'>";
							echo "<li>".$this->Html->link(__('View User'), array('controller'=>'Users', 'action'=>'viewUser', $row['User']['id'], 'page'=>$page), array('escape'=>false))."</li>";
								...
								//For future: need to make a page for Administrators to edit users. (we had one, but I deleted it during the
								//great purge of bullshit that was lagging the site)
